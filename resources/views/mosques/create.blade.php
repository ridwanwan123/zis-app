...
@section('content')
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"> <a href="{{ route('mosque') }}"
                style="color: unset !important"> Data Masjid </a>/</span> Tambah Data</h4>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form enctype="multipart/form-data" method="POST" action="{{ route('mosque.store') }}">
                @csrf
                <!-- input -->
                <div class="row g-3 col-lg-12">
                    <div class="col mb-3">
                        <label for="name_mosque" class="form-label">Nama Masjid</label>
                        <input type="text" class="form-control" id="name_mosque" value="{{ old('name_mosque') }}"
                ...
                <div class="row g-3 col-lg-12">
                    <div class="col mb-3">
                        ...
                        <textarea class="form-control" id="address_mosque" name="address_mosque" rows="6">{{ old('address_mosque') }}</textarea>
                    </div>
                </div>
