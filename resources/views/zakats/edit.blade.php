...
@section('content')
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"> <a href="{{ route('zakat') }}"
                style="color: unset !important"> Data Zakat </a>/</span> Update Data</h4>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form enctype="multipart/form-data" method="POST" action="{{ route('zakat.update', $zakat->id) }}">
                @method('PUT')
                @csrf
                <!-- input -->
                <div class="col-lg-12">
                    <div class="col mb-3">
                        ...
                        <select name="jenis_zakat" class="form-select">
                            <option value="{{ $zakat->jenis_zakat }}" selected> {{ $zakat->jenis_zakat }} </option>
                ...
                <div class="col-lg-12">
                    <div class="col mb-3">
                        ...
                        <input type="text" class="form-control" id="nama_donatur" value="{{ $zakat->nama_donatur }}"
                ...
                <div class="col-lg-12">
                    <div class="col mb-3">
                        ...
                        <input type="number" class="form-control" placeholder="Harap Menggunakan 62" id="phone"
                            value="{{ $zakat->phone }}" name="phone" aria-describedby="phone">
                    </div>
                </div>
                ...
                <div class="g-3 mb-3 col-lg-12 input-group input-group-merge">
                    ...
                    <input type="text" class="form-control" placeholder="40000"
                        aria-label="Amount (to the nearest ruppiah)" id="nominal" value="{{ $zakat->nominal }}"
                ...
                <div class="col mb-3 ">
                    ...
                    <select name="id_mosque" class="form-select">
                        <option value="{{ $zakat->id_mosque }}" selected>{{ $zakat->mosque->name_mosque }}
                        </option>
                        @foreach ($mosques as $mosque)
                            @if ($zakat->id_mosque != $mosque->id)
                ...
                <div class="col-lg-12">
                    <div class="col mb-3">
                        ...
                        <select name="status" class="form-select">
                            <option value="{{ $zakat->status }}" selected> {{ $zakat->status }} </option>
